        ...
        function updateVisualization(carbonIntensity) {
            ...
            const carbonCard = document.querySelector('.data-card.carbon-intensity');
        ...
        function switchCountry(countryCode) {
            ...
            document.querySelectorAll('.country-card').forEach(card => {
                ...
                if (card.classList.contains(countryData[countryCode].class)) {
        ...
        async function displayData() {
            ...
            if (data) {
                ...
                carbonElement.textContent = 'Data not available';
                dateElement.textContent = 'Connection failed';
                timeElement.textContent = 'Try again later';
